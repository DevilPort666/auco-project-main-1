      ...
      {showModal && (
        <div className="fixed z-10 inset-0 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen">
            <div className="fixed inset-0 bg-gray-500 bg-opacity-60"></div>
            <div className="card z-50 rounded-lg p-8">
            <div className="flex justify-center">
              <div className="relative rounded-full w-36 h-36 overflow-hidden">
                    <Image
                        src="https://media.licdn.com/dms/image/D4E03AQFGS5ZNClliTg/profile-displayphoto-shrink_800_800/0/1694446884676?e=1700092800&v=beta&t=E-JcsxwDyuXnXPFUnnIxjXffdu_UxC9BWhJwmr-v_r8"
                        alt="Profile picture"
                        layout="fill"
                        objectFit="cover"
                    />
              ...
              <h2 className="text-2xl font-bold mb-4 mt-8 text-center">Juan Manuel Solís</h2>
              <h3 className="text-2x1 mt-0 mb-4 text-center">Full Stack Developer</h3>
              <div className="flex justify-center space-x-4">
                <a href="https://github.com/jmslasso" target="_blank" rel="noopener noreferrer">
                    <svg className="w-16 h-16 fill-current text-gray-400 hover:text-gray-300" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 100 100">
                ...
                <a href="https://www.linkedin.com/in/jmslasso" target="_blank" rel="noopener noreferrer">
                    <svg className="w-16 h-16 fill-current text-gray-400 hover:text-gray-300" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
